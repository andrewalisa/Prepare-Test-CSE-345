...
<html lang="en">
  <head>
    ...
    <title>Confirm your Reading Test</title>
...
<?php include_once ('include/header/nav.php'); ?>
    ...
    <div class="jumbotron">
      <div class="container">
        <h1>Confirm Your Reading Test</h1>
        <p><b><i>Please review the following:</i></b></p><br/>
          <p>Your selected subject: <span style="color: red;">Reading</span></p>
          ...
          <p><a class="btn btn-primary btn-lg" href='<?php echo base_url()."Main/reading_test/"; ?><?=$diff; ?>' role="button">Start &raquo;</a></p>
      </div>
    </div>
